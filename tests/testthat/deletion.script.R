...
# sim truth
  ...
  #mp <- McmcParams(iter=4000, burnin=2000, thin=1, param_updates=up)
  mp <- McmcParams(iter=4000, burnin=2000, thin=1, nStarts=4)
  #mp <- McmcParams(iter=4000, burnin=2000, thin=1)
  #mp <- McmcParams(iter=5000, burnin=0, thin=1)
...
pathout <- file.path("/dcs01/chaklab/chaklab1/users/mchou/batchrun6/results")
...
setwd("/dcs01/chaklab/chaklab1/users/mchou/batchrun6/results")
