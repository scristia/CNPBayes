...
If the mixture components were always as well separated as above, standard Bayesian and frequentist regression models using the maximum a posteriori copy number estimate would be appropriate.
...
```{r posterior_summaries, fig.align="center", fig.cap="Traceplot of the copy number regression coefficient. The horizontal line indicates the true value of this parameter.", fig.width=8, fig.height=3}
