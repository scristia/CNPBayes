...
mlist.marginal <- list(posteriorSimulation(model.marginal, k=1),
                       posteriorSimulation(model.marginal, k=2),
                       posteriorSimulation(model.marginal, k=3),
                       posteriorSimulation(model.marginal, k=4))

mlist.batch <- list(posteriorSimulation(model.batch, k=1),
                    posteriorSimulation(model.batch, k=2),
                    posteriorSimulation(model.batch, k=3),
                    posteriorSimulation(model.batch, k=4))
```
...
top.two.marginal <- mlist.marginal[order(marginal.lik, decreasing=TRUE)[1:2]]
top.two.batch <- mlist.batch[order(batch.lik, decreasing=TRUE)[1:2]]
logBayesFactor(top.two.marginal)
logBayesFactor(top.two.batch)
```
