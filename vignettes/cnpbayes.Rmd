...
While we cannot really determine whether a given model has converged, we can usually tell when it has not.  Here, we illustrate how one can access the chains from the `MultiBatch` instances created in the preceding analses. 
