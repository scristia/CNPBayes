...
proportion_thesame <- mean(abs(pz.w.augmentation[, 1] -
                               pz.wo.augmentation[, 1]) < 0.1)
```

The above results demonstrate that `r round(proportion_thesame, 3)*100`% of the posterior probabilities are the same between the restricted model (without augmentation and homozygous deletions removed) to the model using augmentation. 
