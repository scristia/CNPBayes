...
requires a `batch` parameter, similar to `Hyperparameters`. A `plot` method is
provided for both `BatchModel` and `MarginalModel`. `plot`s of `BatchModel`s
include batch specific density estimates.
