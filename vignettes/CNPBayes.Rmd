...
Batch effect can vary by CNP locus. Thus, we have to estimate copy number at
each locus. 

Batch effect refers to the differences between groups of samples due to
technical reasons. These reasons can include differences in date, temperature,
or lab technician. Since batch is unknown *a priori*, we use chemistry plates
