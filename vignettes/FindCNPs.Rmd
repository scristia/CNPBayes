...
# have set of SNPs with log r ratios and then summarize in some way. use some of the data from the vanilla ices vignette and then use that here. has SNP data for chromosome and we just have to simulate more of it.
